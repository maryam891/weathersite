  ...
  <div class="home">
    ...
    <div class="col-6 offset-3">
      <div class="maindiv vh-100">
        <b-input-group>
          <template #prepend>
            <b-input-group-text class="cursorPointer" @click="checkWeather">Search</b-input-group-text>
          </template>
          ...
          <template #append>
            ...
            >
              ...
              <b-dropdown-item @click="city='England'">England</b-dropdown-item>
              <b-dropdown-item @click="city='USA'">USA</b-dropdown-item>
              <b-dropdown-item @click="city='Australia'">Australia</b-dropdown-item>
            </b-dropdown>
          </template>
        </b-input-group>
